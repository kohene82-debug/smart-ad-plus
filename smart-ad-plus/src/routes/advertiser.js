...
consconst { authenticateAdvertiser, authenticateUser } = require('../middlewares/auth');t { authenticateAdvertiser } = require('../middlewares/auth');
...
router.get('/ads',       authenticateUser, ctrl.getAds);router.post('/fundAccount',   authenticateAdvertiser, validate(schemas.fundAccount),  ctrl.fundAccount);
